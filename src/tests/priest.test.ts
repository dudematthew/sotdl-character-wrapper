...
describe("Priest Character", () => {
	...
	test("Level 1 priest abilities", () => {
		...
		expect(attrs.health).toBe(15); // Base 10 + 4 from level 1 + 1 default attribute increase
	...
	test("Level 2 priest abilities", () => {
		...
		const attrs = character.attributes;
		expect(attrs.power).toBe(1);
		expect(attrs.health).toBe(19); // Base 10 + 4 + 4 + 1 default attribute increase
	...
	test("Level 5 priest abilities", () => {
		...
		expect(attrs.health).toBe(28); // Base 10 + (4 * 5) + ancestry bonus at level 4 + 1 default attribute increase
	...
	test("Level 8 priest abilities", () => {
		...
		const attrs = character.attributes;
		expect(attrs.power).toBe(2);
		expect(attrs.health).toBe(32); // Base 10 + (4 * 8) + ancestry bonus at level 4 + 1 default attribute increase
